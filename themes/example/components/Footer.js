...
export const Footer = (props) => {
  ...
  return <footer className="z-10 relative w-full bg-white px-6 border-t  ">
        ...
        <div className="container mx-auto max-w-4xl py-6 md:flex flex-wrap md:flex-no-wrap md:justify-between items-center text-sm">
            <div className='text-center text-neutral-100'> &copy;{`${copyrightDate}`} {BLOG.AUTHOR}. All rights reserved.</div>
            <div className="md:p-0 text-center md:text-right text-xs text-neutral-100">
                {/* 右侧链接 */}
                ...
                <span className='text-neutral-100 dark:text-gray-200 no-underline ml-4 '>
                    Powered by
